...
Once you have the new array created, sort the universities alphabetically and log the result. */
 ...
 universityNames.forEach(school => {
   return (universities.push(`${school.university}`))
   university.sort ();
 })
 ...
 in their name. Create a new array called unisWithUni that contains them all. 
...
const populationTotal = 0;
 const populationTotal = zooAnimals.reduce((sum, curr) =>
       sum + curr.population, 0
 )
